...
import { Italiana, Sen , Quicksand,Caveat,Cinzel,Montserrat} from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${italiana.variable} ${sen.variable} ${cinzel.variable} ${caveat.variable} ${quicksand.variable} bg-second font-quicksand`}>
        {children}
