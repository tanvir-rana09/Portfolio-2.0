	...
	return (
		<div>
			...
			<div className={`${className}  flex flex-col items-start gap-5`}>
				...
				<Link className='text-gray-100 bg-third px-10 py-2.5 rounded-md shadow-md w-full text-center uppercase font-sen tracking-widest text-sm xl:w-auto' href={link}>Case Study</Link>
			</div>
		</div>
